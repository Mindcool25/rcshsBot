"""
Originally By: https://github.com/stroupbslayen/discord-pretty-help
"""
...
class Paginator:
    """A class that creates pages for Nextcord messages.
    Attributes
    -----------
    ...
    def _check_embed(self, embed: nextcord.Embed, *chars: str):
        """
        Check if the emebed is too big to be sent on nextcord
        Args:
    ...
    def _new_page(self, title: str, description: str):
        ...
        Returns:
            nextcord.Emebed: Returns an embed with the title and color set
        """
    ...
    def _add_command_fields(
        ...
        Args:
            embed (nextcord.Embed): The page to add command descriptions
